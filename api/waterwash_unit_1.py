...
"""
mean_rate_query_body = """SELECT mean("waterwash_rate") AS "mean_waterwash_rate" FROM unit1 WHERE time > now() - 2m """
            ...
            if df.index == my_data.index:
               ...
               # print("Pn: ", mownost_nagnetatelya.values)
                ...
                if  waterwash_check['status'] > waterwash:
                    ...
                    upload_whole_time_waterwash_alert = writer_client.write_points(pd_whole_time_waterwash_alert, 'unit1')
                ...
                print(type(turbine_power))
                print(type(poterya_mownosti))
                print(type(waterwash))
                print(type(armani))
                print(type(waterwash_rest_time))
                print(type(acc_loss_index))
                print(type(waterwash_delta_time_now))
                print(type(vremya_alert_waterwash))
                ...
                try:
                    ...
                    upload_data_to_influx = writer_client.write_points(data_to_influx, ' unit1')

                    print("UNIT_1: Connected")


                except:

                    print("UNIT_1: Imitation model is not working")
                ...
                upload_waterwash_over_time = writer_client.write_points(waterwash_over_time, ' unit1')

                upload_power_e = power_e_writer_client.write_points(data_to_influx_power_e, 'unit1')

        else:

            print("The UNIT 1 is not RUNNING")


    except:

        print("UNIT_1: DATABASE NOT FOUND")
