...
def notifier():
    ...
    rs5 = client.query(
        "SELECT last(\"object_discription\"), last(\"messagetext\"), last(\"alerttext\"), last(\"title\")  FROM labview.autogen.events_alerts WHERE time > now() - 15s;")
    ...
    try:
        ...
        _ = requests.post(url='http://localhost:5000/notify',
